# Revisión de la Presentación — Propuesta Comercial de Patrocinio VOIT

Análisis del archivo `presentacion voit (1).pdf` (8 láminas) y del anexo `Flujo de personas Chitiva (1).pdf`.

---

## 1. Estructura actual detectada

| # | Lámina | Contenido | Diagnóstico |
|---|---|---|---|
| 1 | Portada | Propuesta Comercial de Patrocinio · AFAC × VOIT · Enero 2026 | Fecha desactualizada |
| 2 | La Academia | Visión, metodología, Andrés Chitiva, sede Pachuca | Sólida |
| 3 | Afinidad de Marca AFAC × VOIT | Voit como marca mexicana, conexión con 4 públicos, denominación oficial | Sólida |
| 4 | Objetivos de la alianza | Integrar a Voit en la experiencia diaria, presencia orgánica, largo plazo | Buena narrativa, va antes de tiempo |
...
### 3.1 Lámina nueva: "Inventario Publicitario" (prioridad máxima)
...
> **UN CLIENTE RECURRENTE, NO SOLO UN PATROCINADO**
> Al término del equipamiento inicial, la Academia adquirirá directamente con VOIT el material adicional que requiera, bajo condiciones de precio preferencial.
> - Reposición y crecimiento de inventario a lo largo del año
> - Cliente institucional con demanda previsible y recurrente
> - Escalable conforme crezca la matrícula y la Liga
...
- **Distribución de lunes a domingo** → constancia, no picos
- **15,000 impactos semanales / 60,000 mensuales**
- El argumento de calidad del impacto: +90 min de atención activa frente a formatos publicitarios de impacto breve

Ese último punto está muy bien redactado en el anexo y no está en la presentación. Es el mejor argumento contra el "mejor pongo el dinero en digital".
...
En la lámina de Vigencia dice:

> *"La información contenida en esta propuesta corresponde a un planteamiento inicial, pensado para iniciar una conversación sobre una posible alianza con VOIT."*

Entiendo la intención legal —evitar que la propuesta sea vinculante— pero colocada al final debilita todo lo anterior justo en el momento de decisión. **Recomendación:** muévela a un pie de página en letra pequeña o a una lámina de aviso legal al final, y deja el cierre para el llamado a la acción. La protección jurídica real la da la cláusula de "Acuerdo total" del contrato, no esta frase en la presentación.

### 4.3 Redundancia entre láminas 4 y 7

La lámina 4 ("La alianza busca: integrar a Voit en la experiencia diaria, generar presencia orgánica y constante, construir relación de largo plazo, abrir oportunidades de crecimiento comercial") repite en lenguaje aspiracional lo que la lámina 7 dice de forma concreta. **Recomendación:** fusiónalas o convierte la lámina 4 en una sola frase de transición. Ganas una lámina para el inventario publicitario sin alargar la presentación.

### 4.4 "Exposición directa a compradores y consumidores"
...
Hay un conflicto entre documentos y dentro del propio anexo de flujo:

| Fuente | Dato |
|---|---|
| Anexo, sección B | "Resultado estimado ligas: ≈ **2,500** personas semanales" |
| Anexo, tabla combinada | Academia 400 + Ligas **+2,100** = Total **+2,500** |
...
## 6. MEJORAR la presentación (forma y orden)

### 6.1 Reordenar: valor antes de petición
...
El PDF pesa **23.9 MB**, casi todo en imágenes. Muchos servidores de correo corporativo rechazan adjuntos de ese tamaño o los truncan. Exporta una versión optimizada de **menos de 10 MB** para envío por correo, y conserva la de alta resolución para presentar en pantalla.

### 6.4 Consolidar el anexo de flujo
